...
const attachEventsToTodoElement = (element, index, dispatch) => {
  ...
  element.querySelector("button.destroy").addEventListener("click", deleteHandler);

  element.querySelector("input.toggle").addEventListener("click", toggleHandler);
  ...
  element.querySelector("input.edit").addEventListener("keypress", updateHandler);
};
